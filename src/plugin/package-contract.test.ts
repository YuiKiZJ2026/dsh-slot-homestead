...
describe("published DSH bundle contract", () => {
  ...
  it("packs only the audited runtime and documentation allowlist", () => {
    ...
    expect(paths).toEqual([
      ...
      "assets/ecosystem-animal-lifecycle-atlas-v2.svg",
      "assets/ecosystem-animal-produce-atlas-v2.svg",
      "assets/ecosystem-arrow.png",
      "assets/ecosystem-bubbles.png",
      "assets/ecosystem-crop-lifecycle-atlas-v2.svg",
      "assets/ecosystem-fish-lifecycle-atlas-v2.svg",
      "assets/ecosystem-garden-bed-v3.png",
      "assets/ecosystem-garden-watering-can-v3.png",
      "assets/ecosystem-night-aquarium-lamp.png",
      "assets/ecosystem-night-garden-lamp.png",
      "assets/ecosystem-night-pasture-lamp.png",
      "assets/ecosystem-reference-aquarium.png",
      "assets/ecosystem-reference-pasture.png",
      "assets/ecosystem-scarecrow.png",
      "assets/ecosystem-slot-equipment-v3.png",
      "assets/ecosystem-water-plant.png",
      "assets/ecosystem-workbench-table-v3.png",
